          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Recove Account</h5>
                  </div>
                  <?php 
                  ...
                  <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="login" value="Sign In" type="submit">Send Mail</button>
                    </div>
                    <div class="col-12 text-center"><br>
                      <p class="small mb-0">Not have an account? <a href="pages-register.php">SignUp Here</a></p>
